...
func (o *TestEventReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *TestEventOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
func (o *TestEventUnauthorized) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
func (o *TestEventForbidden) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
func (o *TestEventNotImplemented) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
