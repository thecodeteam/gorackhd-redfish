...
func (m *ChassisCollectionChassisCollection) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ChassisCollectionChassisCollection) validateMembers(formats strfmt.Registry) error {
...
func (m *ChassisCollectionChassisCollection) validateMembersAtOdataNavigationLink(formats strfmt.Registry) error {
