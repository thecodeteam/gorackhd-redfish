...
var manager100GraphicalConsoleConnectTypesSupportedItemsEnum []interface{}

func (m *Manager100GraphicalConsole) validateConnectTypesSupportedItemsEnum(path, location string, value string) error {
	if manager100GraphicalConsoleConnectTypesSupportedItemsEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["KVMIP","Oem"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			manager100GraphicalConsoleConnectTypesSupportedItemsEnum = append(manager100GraphicalConsoleConnectTypesSupportedItemsEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, manager100GraphicalConsoleConnectTypesSupportedItemsEnum); err != nil {
		return err
	}
	return nil
}

func (m *Manager100GraphicalConsole) validateConnectTypesSupported(formats strfmt.Registry) error {
...
func (m *Manager100GraphicalConsole) validateMaxConcurrentSessions(formats strfmt.Registry) error {
