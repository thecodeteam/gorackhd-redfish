...
func (m *SimpleStorageCollectionSimpleStorageCollection) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SimpleStorageCollectionSimpleStorageCollection) validateMembers(formats strfmt.Registry) error {
...
func (m *SimpleStorageCollectionSimpleStorageCollection) validateMembersAtOdataNavigationLink(formats strfmt.Registry) error {
