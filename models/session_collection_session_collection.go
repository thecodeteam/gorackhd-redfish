...
func (m *SessionCollectionSessionCollection) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SessionCollectionSessionCollection) validateMembers(formats strfmt.Registry) error {
...
func (m *SessionCollectionSessionCollection) validateMembersAtOdataNavigationLink(formats strfmt.Registry) error {
