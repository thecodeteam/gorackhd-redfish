...
func (m *LogEntryCollectionLogEntryCollection) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LogEntryCollectionLogEntryCollection) validateMembers(formats strfmt.Registry) error {
...
func (m *LogEntryCollectionLogEntryCollection) validateMembersAtOdataNavigationLink(formats strfmt.Registry) error {
