...
func (m *EventDestinationCollectionEventDestinationCollection) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EventDestinationCollectionEventDestinationCollection) validateMembers(formats strfmt.Registry) error {
...
func (m *EventDestinationCollectionEventDestinationCollection) validateMembersAtOdataNavigationLink(formats strfmt.Registry) error {
