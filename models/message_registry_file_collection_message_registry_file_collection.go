...
func (m *MessageRegistryFileCollectionMessageRegistryFileCollection) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MessageRegistryFileCollectionMessageRegistryFileCollection) validateMembers(formats strfmt.Registry) error {
