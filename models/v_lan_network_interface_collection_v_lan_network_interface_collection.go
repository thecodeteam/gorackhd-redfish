...
func (m *VLanNetworkInterfaceCollectionVLanNetworkInterfaceCollection) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VLanNetworkInterfaceCollectionVLanNetworkInterfaceCollection) validateMembers(formats strfmt.Registry) error {
...
func (m *VLanNetworkInterfaceCollectionVLanNetworkInterfaceCollection) validateMembersAtOdataNavigationLink(formats strfmt.Registry) error {
