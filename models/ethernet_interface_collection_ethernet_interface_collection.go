...
func (m *EthernetInterfaceCollectionEthernetInterfaceCollection) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EthernetInterfaceCollectionEthernetInterfaceCollection) validateMembers(formats strfmt.Registry) error {
...
func (m *EthernetInterfaceCollectionEthernetInterfaceCollection) validateMembersAtOdataNavigationLink(formats strfmt.Registry) error {
