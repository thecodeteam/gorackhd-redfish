...
func (m *RoleCollectionRoleCollection) validateMembers(formats strfmt.Registry) error {
...
func (m *RoleCollectionRoleCollection) validateMembersAtOdataNavigationLink(formats strfmt.Registry) error {
