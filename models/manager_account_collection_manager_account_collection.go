...
func (m *ManagerAccountCollectionManagerAccountCollection) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ManagerAccountCollectionManagerAccountCollection) validateMembers(formats strfmt.Registry) error {
...
func (m *ManagerAccountCollectionManagerAccountCollection) validateMembersAtOdataNavigationLink(formats strfmt.Registry) error {
